...
if __name__ == '__main__':
    ...
    parser.add_argument('-w', action='store', type=str, default="/home/nics/Escritorio/dataset/wrapper", 
    ...
    ssh.connect('192.168.1.3', username='nics', password='nics,2024.')
    ...
    timeout = int(1.5*float(nbSamples)/freq*1e6) #measurement time in us
